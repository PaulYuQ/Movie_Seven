...
<head>
    ...
    <title>Movie SEVEN,影柒，做中国最牛逼的电影网站------科幻片</title>
    ...
    <script>
        ...
        $(function () {
            ...
            myBtn();
            var moviesCount;
            $.post("/movie/getMoviesCount.do",{"name": "科幻片"},function (data) {
        ...
        function load(currentPage) {
            $.get("/movie/initAnyMovies.do",{"name": "科幻片","currentPage":currentPage}, function (data) {
                var dataJson = $.parseJSON(data);
    ...
    <div class="fed-part-case">
        <div class="fed-navs-info">
            <ul class="fed-menu-info">
                ...
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-hide fed-show-md-block" name="fed-a"
                       href="/science.jsp" style="color: #2196F3!important">科幻片</a>
                </li>
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-hide fed-show-md-block" name="fed-a"
