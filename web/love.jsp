...
<head>
    ...
    <title>Movie SEVEN,影柒，做中国最牛逼的电影网站------爱情片</title>
    ...
    <script>
        ...
        $(function () {
            ...
            myBtn();
            var moviesCount;
            $.post("/movie/getMoviesCount.do",{"name": "爱情片"},function (data) {
        ...
        function load(currentPage) {
            $.get("/movie/initAnyMovies.do",{"name": "爱情片","currentPage":currentPage}, function (data) {
                var dataJson = $.parseJSON(data);
            ...
            <ul class="fed-menu-info">
                ...
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-hide fed-show-lg-block" name="fed-a"
                       href="/love.jsp" style="color: #2196F3!important">爱情片</a>
                </li>
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-hide fed-show-lg-block" name="fed-a"
