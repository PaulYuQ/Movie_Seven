...
<head>
    ...
    <title>Movie SEVEN,影柒，做中国最牛逼的电影网站------纪录片</title>
    ...
    <script>
        ...
        $(function () {
            ...
            myBtn();
            var moviesCount;
            $.post("/movie/getMoviesCount.do",{"name": "纪录片"},function (data) {
        ...
        function load(currentPage) {
            $.get("/movie/initAnyMovies.do",{"name": "纪录片","currentPage":currentPage}, function (data) {
                var dataJson = $.parseJSON(data);
        ...
        <div class="fed-navs-info">
            <ul class="fed-menu-info">
                ...
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-text-greens fed-hide fed-show-md-block" name="fed-a" id="home-a"
                       href="/">首页</a>
                </li>
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-hide fed-show-md-block" name="fed-a"
                       href="/action.jsp" onclick="initMovies(this)" >动作片</a>
                </li>
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-hide fed-show-md-block" name="fed-a"
                       href="/comedy.jsp" onclick="initMovies(this)">喜剧片</a>
                </li>
                <li class="fed-pull-left">
                ...
                <li class="fed-pull-left">
                    <a class="fed-menu-title fed-show-kind fed-font-xvi fed-hide fed-show-md-block" name="fed-a"
                       href="/documentary.jsp"  style="color: #2196F3!important">纪录片</a>
                </li>
                <li class="fed-pull-left">
            ...
            <div class="fed-part-layout fed-back-whits">
                <div class="fed-list-head fed-part-rows fed-padding">
                    ...
                    <ul class="fed-part-tips fed-padding">
                        <li>&nbsp;&nbsp;&nbsp;共&nbsp;<span class="fed-text-green" id="movie-sum">&nbsp;</span>&nbsp;部</li>
