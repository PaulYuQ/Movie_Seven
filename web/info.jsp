...
<div class="row row-info">
    <div class="info-center">
        <div>
            <div class="col-lg-2">
                <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1600314127342&di=3113df7e6be597c6ab63a0b6dfd6be73&imgtype=0&src=http%3A%2F%2Fbpic.588ku.com%2Felement_origin_min_pic%2F01%2F31%2F76%2F99573b52787e93b.jpg"
            ...
            <div class="col-lg-10">
                <form action="${pageContext.request.contextPath}/modify.users?name=${name}" class="form-info">
                    ...
                    <div style="margin-top: 40px;display: block">
                        <input type="button" class="btn btn-lg  btn-info" style="margin-left:300px" onclick="update()"
                               value="修改">
